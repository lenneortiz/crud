$(document).on('ready',function(){
    ...
    $("#login").on('click',function(){
        ...
        {  
          $.ajax({
            ...
            {  
              ...
              if(resp[0]==1){
                ...
                $("body").load("views/home.php",function(){
                        ...
                        $('#modal-dialog-invalid').dialog({
                          ...
                          hide:{
                            ...
                            $(".logout").on('click',function(event){
                                event.preventDefault();
                              window.location='controller/usuarioController.php?action=logout';
                            });


                  })//and carga pagina login
                .hide().fadeIn(1500);  

              }else if(resp[0]==3){
                $('#login').val("Login");
                $('#error').html("<span class='text-danger'>usuario no encontrado</span>");
          ...
          $('#error').html("<span class='text-danger'>Por favor complete todos los campos</span>");
        }
